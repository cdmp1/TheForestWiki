...
def email_no_repetido_validator(value):
...
class RegistroUsuarioForm(forms.Form):
    nombre_usuario = forms.CharField(
        ...
        validators=[
            MinLengthValidator(2, "El nombre de usuario debe tener al menos 2 caracteres."),
    ...
    # Campo de correo con validación para verificar que no esté repetido
    email = forms.EmailField(
        required=True,
        label='Correo Electrónico',
        max_length=50,
        validators=[email_no_repetido_validator] 
    )
